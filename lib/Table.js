  ...
  function Table(props) {
    ...
    _this.syncFixedTableRowHeight = function() {
      ...
      if (
        ...
        (0, _shallowequal2['default'])(state.fixedColumnsBodyRowsHeight, fixedColumnsBodyRowsHeight)
      ) {
        return;
      }
    ...
    [
      ...
      (0,
      _utils.warningOnce)(props[name] === undefined, name + ' is deprecated, please use onRow instead.');
    });
    ...
    [
      ...
      },
      {
        ...
        value: function setScrollPosition(position) {
          ...
          if (this.tableNode) {
            ...
            if (position === 'both') {
              (0, _componentClasses2['default'])(this.tableNode)
      ...
      },
      {
        ...
        value: function renderMainTable() {
          ...
          return scrollable
            ? _react2['default'].createElement('div', { className: prefixCls + '-scroll' }, table)
            : table;
        },
      },
      {
...
Table.propTypes = (0, _extends3['default'])(
  {
    ...
    emptyText: _propTypes2['default'].oneOfType([
