...
var ExpandableTable = (function(_React$Component) {
  ...
  function ExpandableTable(props) {
    ...
    var _this = (0, _possibleConstructorReturn3['default'])(
      this,
      (ExpandableTable.__proto__ || Object.getPrototypeOf(ExpandableTable)).call(this, props),
    );
...
var _initialiseProps = function _initialiseProps() {
  ...
  this.handleExpandChange = function(expanded, record, event, rowKey) {
    ...
    if (
      ...
      !(0, _shallowequal2['default'])(_this3.latestExpandedRows, expandedRowKeys)
    ) {
  ...
  this.renderRows = function(
    ...
    var nextAncestorKeys = [].concat((0, _toConsumableArray3['default'])(ancestorKeys), [
      parentKey,
    ]);
    ...
    if (childrenData) {
      rows.push.apply(
        rows,
        (0, _toConsumableArray3['default'])(renderRows(childrenData, nextIndent, nextAncestorKeys)),
      );
    }
  };
};
