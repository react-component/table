...
describe('Table.Hover', () => {
  ...
  it('basic', () => {
    ...
    fireEvent.mouseLeave(container.querySelector('tbody td'));
  ...
  it('warning if use `render` for rowSpan', () => {
    ...
    expect(container.querySelectorAll('td.rc-table-cell-row-hover')).toHaveLength(2);
    ...
    // Mouse leave
    fireEvent.mouseLeave(container.querySelectorAll('tbody td')[1]);
    expect(container.querySelector('.rc-table-cell-row-hover')).toBeFalsy();
  ...
  it('onCell should work', () => {
    ...
    // Hover 0-0
    fireEvent.mouseEnter(container.querySelectorAll('tbody td')[0]);
    expect(container.querySelectorAll('td.rc-table-cell-row-hover')).toHaveLength(3);
  ...
  it('perf', () => {
    ...
    fireEvent.mouseLeave(container.querySelectorAll('tbody td')[0]);
    expect(container.querySelector('.rc-table-cell-row-hover')).toBeFalsy();
